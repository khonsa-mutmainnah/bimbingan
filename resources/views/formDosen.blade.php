...
<body>
    ...
    <form action="{{ url('dosen/tambah')}}" method="POST" enctype="multipart/form-data" style="margin-top: 50px;">
    @csrf
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="nidn" placeholder="nidn" style="width: 600px;" name="nidn">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
        <input type="text" class="form-control" id="kontak" placeholder="yyyy" style="width: 600px;" name="kontak">
        </div>
    </div>
    <div class="form-group">
